...
public class Main {
	...
	public static void main(String[] args) throws Exception {
			String input_file = "data/aiger-set/ascii/aig_5_min.aag";
...
/*			GraphWrapper graph = Input_Parser.Invoke_Parser(input_file);
			...
			ABC.EquivalenceCheck.performEquivalenceCheck(new File("data/aiger-set/blif/aig_5_min.blif"), new File("output/unmodifiedGraph.blif"));
